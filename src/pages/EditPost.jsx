...
import { Save, Eye, Image, Tag, ArrowLeft } from 'lucide-react';
...
const EditPost = () => {
  ...
  const mockPost = {
    ...
    content: '<p>React Hooks revolutionized how we write React components. In this comprehensive guide, we\'ll explore the most commonly used hooks and how to implement them effectively in your applications.</p><h2>What are React Hooks?</h2><p>Hooks are functions that let you "hook into" React state and lifecycle features from function components.</p>',
  ...
  useEffect(() => {
    const loadPost = async () => {
      ...
      try {
        ...
        setValue('excerpt', mockPost.excerpt);
